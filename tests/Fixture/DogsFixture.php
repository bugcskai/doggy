...
class DogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'breed' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'time_located' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => ''],
        'picture' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'dogs_ibfk_1' => ['type' => 'foreign', 'columns' => ['place_id'], 'references' => ['places', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'time_located' => '2020-10-30 03:43:10',
                'picture' => 'Lorem ipsum dolor sit amet',
                'place_id' => 1,
                'created' => '2020-10-30 03:43:10',
                'modified' => '2020-10-30 03:43:10',
            ],
        ];
        parent::init();
    }
